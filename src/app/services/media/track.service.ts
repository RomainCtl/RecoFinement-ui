...
export class TrackService {
  ...
  private urlBadRecommendation = environment.api_url + '/track/{track_id}/bad_recommendation';
  ...
  badRecommendation(trackId: number, payload: any) {
    this.httpClient.post<any>(this.urlBadRecommendation.replace('{track_id}', trackId.toString()), payload);
  }
